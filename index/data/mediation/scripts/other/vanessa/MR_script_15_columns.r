...
exposure_data <- read_exposure_data(
  filename = "/newhome/vt6347/NMR_ukbb/females/instruments/15_columns/nmr_instruments_15_columns.txt" ,
  sep = '\t',
  snp_col = "SNP",
  beta_col = "BETA",
  se_col = "SE",
...
write.csv(mr_results, "/newhome/vt6347/NMR_ukbb/females/results/result2.csv")
