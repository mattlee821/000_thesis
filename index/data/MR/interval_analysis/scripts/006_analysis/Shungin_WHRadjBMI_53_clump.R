...
### save plots ====
pdf("006_interval_metabolites/analysis/WHRadjBMI_Shungin_53/plot_mr_scatter_clump.pdf")
for (i in 1:length(plot_mr_scatter_clump)) {
  print(plot_mr_scatter_clump[[i]])
}
dev.off()

pdf("006_interval_metabolites/analysis/WHRadjBMI_Shungin_53/plot_singlesnp_forest_clump.pdf")
for (i in 1:length(plot_singlesnp_forest_clump)) {
  print(plot_singlesnp_forest_clump[[i]])
}
dev.off()

pdf("006_interval_metabolites/analysis/WHRadjBMI_Shungin_53/plot_leaveoneout_forest_clump.pdf")
for (i in 1:length(plot_leaveoneout_forest_clump)) {
  print(plot_leaveoneout_forest_clump[[i]])
}
dev.off()

pdf("006_interval_metabolites/analysis/WHRadjBMI_Shungin_53/plot_mr_funnel_clump.pdf")
...
## Save output ====
write.table(exposure_data_clump, "006_interval_metabolites/analysis/WHRadjBMI_Shungin_53/exposure_data_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(outcome_data_clump, "006_interval_metabolites/analysis/WHRadjBMI_Shungin_53/outcome_data_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(harmonise_data_clump, "006_interval_metabolites/analysis/WHRadjBMI_Shungin_53/harmonise_data_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_results_clump, "006_interval_metabolites/analysis/WHRadjBMI_Shungin_53/mr_results_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_singlesnp_clump, "006_interval_metabolites/analysis/WHRadjBMI_Shungin_53/mr_singlesnp_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_hetrogeneity_clump, "006_interval_metabolites/analysis/WHRadjBMI_Shungin_53/mr_hetrogeneity_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_pleiotropy_clump, "006_interval_metabolites/analysis/WHRadjBMI_Shungin_53/mr_pleiotropy_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_leaveoneout_clump, "006_interval_metabolites/analysis/WHRadjBMI_Shungin_53/mr_leaveoneout_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
