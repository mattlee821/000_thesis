...
setwd("/Users/ml16847/OneDrive - University of Bristol/001_projects/005_systematic_review/analysis/meta_analysis/data_for_analysis/")
list_files <- list.files("/Users/ml16847/OneDrive - University of Bristol/001_projects/005_systematic_review/analysis/meta_analysis/data_for_analysis/")
list <- list()
...
dev.off()
png(paste("../../../figures/meta_analysis_results_figures/", b,".png", sep = ""), height = 4, width = 10, units = "in", res = 100)
forest(results, studlab = T, comb.fixed = F, comb.random = T, leftcols = c("studlab", "doi"))
grid.text(c, .5, 0.8, gp=gpar(cex=1.4))
dev.off()
### table
...
dev.off()
png("../../../figures/meta_analysis_results_figures/continuous_outcomes.png", height = 13, width = 8, units = "in", res = 100)
forest(results, byvar = results$label_ID, studlab = T, comb.fixed = F, comb.random = T, overall = F, overall.hetstat = F, leftcols = c("studlab", "QA"),
       bylab = results$label_ID, rightcols = c("effect", "ci", "w.random"))
dev.off()
...
forest(results1, byvar = results$label_ID, studlab = T, comb.fixed = F, comb.random = T, overall = F, overall.hetstat = F, leftcols = c("studlab", "QA"),
       bylab = results$label_ID, rightcols = c("effect", "ci", "w.random"))
dev.off()
png("../../../figures/meta_analysis_results_figures/binary_outcomes1.png", height = 15, width = 8, units = "in", res = 100)
forest(results1, byvar = results$label_ID, studlab = T, comb.fixed = F, comb.random = T, overall = F, overall.hetstat = F, leftcols = c("studlab","QA"),
       bylab = results$label_ID, rightcols = c("effect", "ci", "w.random"))
dev.off()
...
forest(results2, byvar = results$label_ID, studlab = T, comb.fixed = F, comb.random = T, overall = F, overall.hetstat = F, leftcols = c("studlab", "QA"),
       bylab = results$label_ID, rightcols = c("effect", "ci", "w.random"))
dev.off()
png("../../../figures/meta_analysis_results_figures/binary_outcomes2.png", height = 15, width = 8, units = "in", res = 100)
forest(results2, byvar = results$label_ID, studlab = T, comb.fixed = F, comb.random = T, overall = F, overall.hetstat = F, leftcols = c("studlab","QA"),
       bylab = results$label_ID, rightcols = c("effect", "ci", "w.random"))
dev.off()
