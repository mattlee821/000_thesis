...
To aid visual comparison between metabolite subclasses, derived measures were visualised separately to non-derived measures, and are presented in the Appendix (\@ref(appendix-observational-figures-circosplots)). Derived measures are metabolites that are not directly measured by the metabolomic array and are instead derived during the processing of the raw NMR spectra. Derived measures include ratios such as cholesterol esters in very large very low density lipoprotein (VLDL) to total lipids in very large VLDL ratio. \par
