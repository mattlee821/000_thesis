...
## Chapter summary {-}
The exploration, interpretation, display, and communication of large association analyses is challenging. Previous studies have used Circos plots, however the process of producing Circos plots is cumbersome and, through personal experience[@Taylor2019], has been time consuming and inefficient. This chapter details `EpiViz`, a web application and `R` package that efficiently produces Circos plots. `EpiViz` is used in the following chapters to gain a global overview and identify patterns of association in observational and Mendelian randomization analyses. `EpiViz` considerably improves the speed and efficiency of producing Circos plots and has been used in multiple studies[@Bos2021; @Bell2020; @Taylor2019] since its development. `EpiViz` is available on [GitHub](https://github.com/mattlee821/EpiViz/).\par
<<<<<<< HEAD
