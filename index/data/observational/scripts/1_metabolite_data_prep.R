...
# children ====
## BBS ====
header <- read.table("index/data/observational/data/metabolomics/raw/BBS_Metabolomics.txt", header = F, sep = "\t", fill = T, nrows = 4, stringsAsFactors = FALSE)
header <- header[,c(3:ncol(header))]
header <- header[2,]

data <- read.table("index/data/observational/data/metabolomics/raw/BBS_Metabolomics.txt", header = F, sep = "\t", fill = T, skip = 4)
...
### save
write.table(data, "index/data/observational/data/metabolomics/data_prep/other/Baseline.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

## F7 ====
header <- read.table("index/data/observational/data/metabolomics/raw/F7_Metabolomics.txt", header = F, sep = "\t", fill = T, nrows = 4, stringsAsFactors = FALSE)
header <- header[,c(2:ncol(header))]
header <- header[2,]

data <- read.table("index/data/observational/data/metabolomics/raw/F7_Metabolomics.txt", header = F, sep = "\t", fill = T, skip = 4)
colnames(data) <- c("aln_qlet", header[1,])
...
### save
write.table(data, "index/data/observational/data/metabolomics/data_prep/other/F7.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
rm(list = ls())

## combine children ====
children_Baseline <- read.table("index/data/observational/data/metabolomics/data_prep/other/Baseline.txt", header = T, sep = "\t")
children_F7 <- read.table("index/data/observational/data/metabolomics/data_prep/other/F7.txt", header = T, sep = "\t")
...
bbs <- e[,1]
f7 <- children_F7[,1]
write.table(f7, "index/data/observational/data/F7_aln.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(bbs, "index/data/observational/data/BBS_aln.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

### combine  
children_7and8 <- bind_rows(children_F7, children_Baseline)
children_7and8 <- children_7and8[,c(1,4:233,235:238)]
write.table(children_7and8, "index/data/observational/data/metabolomics/data_prep/final/children_metabolites.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
h$group<- "Baseline"
i <- rbind(g,h)
write.table(i, "index/data/observational/data/metabolomics/data_prep/other/children_unique_metabolites.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
## TF3 ====
header <- read.table("index/data/observational/data/metabolomics/raw/TF3_Metabolomics.txt", header = F, sep = "\t", fill = T, nrows = 4, stringsAsFactors = FALSE)
header <- header[,c(2:ncol(header))]
header <- header[2,]

data <- read.table("index/data/observational/data/metabolomics/raw/TF3_Metabolomics.txt", header = F, sep = "\t", fill = T, skip = 4)
colnames(data) <- c("aln_qlet", header[1,])
...
### save
write.table(data, "index/data/observational/data/metabolomics/data_prep/other/TF3.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

## TF4 ====
header <- read.table("index/data/observational/data/metabolomics/raw/TF4_Metabolomics.txt", header = F, sep = "\t", fill = T, nrows = 4, stringsAsFactors = FALSE)
header <- header[,c(2:ncol(header))]
header <- header[2,]

data <- read.table("index/data/observational/data/metabolomics/raw/TF4_Metabolomics.txt", header = F, sep = "\t", fill = T, skip = 4)
colnames(data) <- c("aln_qlet", header[1,])
...
### save
write.table(data, "index/data/observational/data/metabolomics/data_prep/other/TF4.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

rm(data, header)

## combine adolescents ====
children_TF3 <- read.table("index/data/observational/data/metabolomics/data_prep/other/TF3.txt", header = T, sep = "\t")
children_TF4 <- read.table("index/data/observational/data/metabolomics/data_prep/other/TF4.txt", header = T, sep = "\t")
...
tf4 <- e[,1]
tf3 <- children_TF3[,1]
write.table(tf3, "index/data/observational/data/tf3_aln.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(tf4, "index/data/observational/data/tf4_aln.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

### combine  
adolescents <- bind_rows(children_TF3, children_TF4)
adolescents <- adolescents[,c(1,4:ncol(adolescents))]
write.table(adolescents, "index/data/observational/data/metabolomics/data_prep/final/adolescents_metabolites.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
# young adults (F24) ====
## F24 ====
header <- read.table("index/data/observational/data/metabolomics/raw/F24_Metabolomics.txt", header = F, sep = "\t", fill = T, nrows = 4, stringsAsFactors = FALSE)
header <- header[,c(3:ncol(header))]
header <- header[2,]

data <- read.table("index/data/observational/data/metabolomics/raw/F24_Metabolomics.txt", header = F, sep = "\t", fill = T, skip = 4)
data <- data[,c(2:ncol(data))]
colnames(data) <- c("aln_qlet", header[1,])
...
### save
write.table(data, "index/data/observational/data/metabolomics/data_prep/other/F24.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
rm(data, header)

### remove all IDs not in the measurement (coded as -1)
children_F24 <- read.table("index/data/observational/data/metabolomics/data_prep/other/F24.txt", header = T, sep = "\t")
a <- subset(children_F24, children_F24[,4] != -1)
a <- a[,c(1,(6:ncol(a)-1))]

#### save list of young adults
aln <- as.data.frame(a[,1])
write.table(aln, "index/data/observational/data/f24_aln.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

### save  
write.table(a, "index/data/observational/data/metabolomics/data_prep/final/young_adults_metabolites.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
# mums (FOM1 and FOM2) ====
## FOM1 ====
header <- read.table("index/data/observational/data/metabolomics/raw/FOM1_Metabolomics.txt", header = F, sep = "\t", fill = T, nrows = 4, stringsAsFactors = FALSE)
header <- header[,c(2:ncol(header))]
header <- header[2,]

data <- read.table("index/data/observational/data/metabolomics/raw/FOM1_Metabolomics.txt", header = F, sep = "\t", fill = T, skip = 4)
...
### save
write.table(data, "index/data/observational/data/metabolomics/data_prep/other/FOM1.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

## FOM2 ====
header <- read.table("index/data/observational/data/metabolomics/raw/FOM2_Metabolomics.txt", header = F, sep = "\t", fill = T, nrows = 4, stringsAsFactors = FALSE)
header <- header[,c(2:ncol(header))]
header <- header[2,]

data <- read.table("index/data/observational/data/metabolomics/raw/FOM2_Metabolomics.txt", header = F, sep = "\t", fill = T, skip = 4)
colnames(data) <- c("aln", header[1,])
...
### save
write.table(data, "index/data/observational/data/metabolomics/data_prep/other/FOM2.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

## combine mums ====
mums_FOM1 <- read.table("index/data/observational/data/metabolomics/data_prep/other/FOM1.txt", header = T, sep = "\t")
mums_FOM2 <- read.table("index/data/observational/data/metabolomics/data_prep/other/FOM2.txt", header = T, sep = "\t")
...
fom2 <- e[,1]
fom1 <- mums_FOM1[,1]
write.table(fom1, "index/data/observational/data/fom1_aln.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(fom2, "index/data/observational/data/fom2_aln.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

### combine and remove multiple mums
mums <- bind_rows(mums_FOM1, mums_FOM2)
write.table(mums, "index/data/observational/data/metabolomics/data_prep/other/adult_female_metabolites.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
## dads ====
header <- read.table("index/data/observational/data/metabolomics/raw/FOF_Metabolomics.txt", header = F, sep = "\t", fill = T, nrows = 4, stringsAsFactors = FALSE)
header <- header[,c(4:ncol(header))]
header <- header[2,]

data <- read.table("index/data/observational/data/metabolomics/raw/FOF_Metabolomics.txt", header = F, sep = "\t", fill = T, skip = 4)
...
### save
write.table(data, "index/data/observational/data/metabolomics/data_prep/other/FOF.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

### remove all IDs not in the measurement (coded as -1)
dads <- read.table("index/data/observational/data/metabolomics/data_prep/other/FOF.txt", header = T, sep = "\t")
dads <- subset(dads, dads[,4] != -1)
dads$qlet <- as.character("F")
write.table(dads, "index/data/observational/data/metabolomics/data_prep/other/adult_male_metabolites.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
aln <- as.data.frame(dads[,1])
write.table(aln, "index/data/observational/data/fof1_aln.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
write.table(adults, "index/data/observational/data/metabolomics/data_prep/final/adult_metabolites.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
write.table(e, "index/data/observational/data/metabolomics/data_prep/other/adult_unique_metabolites.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
write.table(data, "index/data/observational/data/metabolomics/data_prep/other/ALSPAC_N.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
