...
write.table(table, "index/data/chapter4/data/analysis/results/bmi/children_qc_model1_lm.txt", 
...
write.table(table, "index/data/chapter4/data/analysis/results/whr/children_qc_model1_lm.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
write.table(table, "index/data/chapter4/data/analysis/results/bf/children_qc_model1_lm.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
rm(list=ls())
...
write.table(table, "index/data/chapter4/data/analysis/results/bmi/adolescents_qc_model1_lm.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
write.table(table, "index/data/chapter4/data/analysis/results/bf/adolescents_qc_model1_lm.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
rm(list=ls())
...
write.table(table, "index/data/chapter4/data/analysis/results/bmi/young_adults_qc_model1_lm.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
write.table(table, "index/data/chapter4/data/analysis/results/whr/young_adults_qc_model1_lm.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
write.table(table, "index/data/chapter4/data/analysis/results/bf/young_adults_qc_model1_lm.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
rm(list=ls())
...
write.table(table, "index/data/chapter4/data/analysis/results/bmi/adults_qc_model1_lm.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
write.table(table, "index/data/chapter4/data/analysis/results/whr/adults_qc_model1_lm.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
write.table(table, "index/data/chapter4/data/analysis/results/bf/adults_qc_model1_lm.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
