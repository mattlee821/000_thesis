...
### save plots ====
pdf("006_interval_metabolites/analysis/WHR_Pulit_316/plot_mr_scatter.pdf")
for (i in 1:length(plot_mr_scatter)) {
  print(plot_mr_scatter[[i]])
}
dev.off()

pdf("006_interval_metabolites/analysis/WHR_Pulit_316/plot_singlesnp_forest.pdf")
for (i in 1:length(plot_singlesnp_forest)) {
  print(plot_singlesnp_forest[[i]])
}
dev.off()

pdf("006_interval_metabolites/analysis/WHR_Pulit_316/plot_leaveoneout_forest.pdf")
for (i in 1:length(plot_leaveoneout_forest)) {
  print(plot_leaveoneout_forest[[i]])
}
dev.off()

pdf("006_interval_metabolites/analysis/WHR_Pulit_316/plot_mr_funnel.pdf")
...
## Save output ====
write.table(exposure_data, "006_interval_metabolites/analysis/WHR_Pulit_316/exposure_data.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(harmonise_data, "006_interval_metabolites/analysis/WHR_Pulit_316/harmonise_data.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_results, "006_interval_metabolites/analysis/WHR_Pulit_316/mr_results.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_singlesnp, "006_interval_metabolites/analysis/WHR_Pulit_316/mr_singlesnp.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_hetrogeneity, "006_interval_metabolites/analysis/WHR_Pulit_316/mr_hetrogeneity.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_pleiotropy, "006_interval_metabolites/analysis/WHR_Pulit_316/mr_pleiotropy.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_leaveoneout, "006_interval_metabolites/analysis/WHR_Pulit_316/mr_leaveoneout.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
